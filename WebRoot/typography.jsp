						  ...
						  <div class="top-menu">
							<nav class="menu menu--francisco">
								<ul class="nav navbar-nav menu__list">
										...
										<li class="menu__item menu__item--current"><a href="typography.jsp" class="menu__link"><span class="menu__helper">医疗指南</span></a></li>
...
<!-- //shortcodes -->
	...
	<div class="footer-bottom">
		<div class="container">
			<p>Â© 2016 Medicinal. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
		</div>
	</div>
